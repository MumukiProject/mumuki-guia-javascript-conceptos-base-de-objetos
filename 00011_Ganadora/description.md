En la `Biblioteca` tenemos un array de objetos `ganadoras`, con las ganadoras de algunas temporadas de Rupaul. Cada objeto tiene las propiedades `nombre`, `temporada` y `foto`.
